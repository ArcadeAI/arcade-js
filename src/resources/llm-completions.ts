...
import * as LlmCompletionsAPI from './llm-completions';

export class LlmCompletions extends APIResource {
  /**
   * Talk to different LLM Chat APIs via OpenAI's API
   */
  create(body: LlmCompletionCreateParams, options?: Core.RequestOptions): Core.APIPromise<ChatResponse> {
...
export interface LlmCompletionCreateParams {
  ...
  messages?: Array<LlmCompletionCreateParams.Message>;
   ...
   */
  stream_options?: LlmCompletionCreateParams.StreamOptions;
...
export namespace LlmCompletionCreateParams {
  export interface Message {
    /**
     * The content of the message.
     */
...
export namespace LlmCompletions {
  export import ChatResponse = LlmCompletionsAPI.ChatResponse;
  export import LlmCompletionCreateParams = LlmCompletionsAPI.LlmCompletionCreateParams;
}
