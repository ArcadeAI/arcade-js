import fs from 'fs';
import type { ResponseLike } from '@arcadeai/arcadejs/internal/to-file';
import { toFile } from '@arcadeai/arcadejs/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@arcadeai/arcadejs/core/uploads');
    await expect(
